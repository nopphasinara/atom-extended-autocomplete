...
const API_URL = 'https://raw.githubusercontent.com/nopphasinara/atom-extended-autocomplete/master/data/advanced.json';
...
class AdvancedProvider {
  constructor() {
    this.selector = '.string, .text, .text.plain, .text.html.basic, .source';
